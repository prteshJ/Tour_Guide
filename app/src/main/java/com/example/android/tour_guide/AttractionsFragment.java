...
public class AttractionsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final ArrayList<Location> attractions = new ArrayList<>(); // Contains all attractions
        attractions.add(0, new Location(getResources(), R.drawable.garfield_park_conservatory, getString(R.string.east_garfield_park_location), getString(R.string.attraction_1)));
        attractions.add(1, new Location(getResources(), R.drawable.the_606, getString(R.string.humboldt_park_location), getString(R.string.attraction_2)));
        attractions.add(2, new Location(getResources(), R.drawable.wrigley_field_baseball_and_softball, getString(R.string.wrigleyville_location), getString(R.string.attraction_3)));
        attractions.add(3, new Location(getResources(), R.drawable.the_second_city_comedy_club, getString(R.string.lincoln_park_location), getString(R.string.attraction_4)));
